...
public class ChangePasswordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            {
                String oldpwd=request.getParameter("txtCurrentPassword");
                String newpwd=request.getParameter("txtNewPassword");
                CommonServices objServices=new CommonServices();
                String msg=objServices.changePassword(oldpwd,newpwd,u_id);
                if(msg.equals("Updated Successfully"))
                {
                    response.sendRedirect("user/Home_mp.jsp?msg=Password Changed Successfully");
                }
                else
                {
                    response.sendRedirect("user/ChangePassword_mp.jsp?msg="+msg);
                }
            }
        } finally {            
            out.close();
